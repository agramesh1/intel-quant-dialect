...
#include "mlir/Dialect/IntelQuantOps/Passes.h"
...
using namespace mlir::intelquant::detail;
...
FunctionPassBase *mlir::intelquant::createLowerUniformCastsPass() {
  return new LowerUniformCastsPass();
}

static PassRegistration<LowerUniformCastsPass>
    lowerUniformCastsPass("intelquant-lower-uniform-casts",
