//===- InferQuantizedTypesIntelPass.cpp - Infers quantized types ---------------===//
//
...
class InferQuantizedTypesIntelPass : public ModulePass<InferQuantizedTypesIntelPass> {
public:
  InferQuantizedTypesIntelPass() = default;
  InferQuantizedTypesIntelPass(SolverContext &solverContext,
...
void InferQuantizedTypesIntelPass::runOnModule() {
  ...
  auto config = IntelQuantTargetConfig::create(solverContext);
  runWithConfig(solverContext, *config);
}

void InferQuantizedTypesIntelPass::runWithConfig(SolverContext &solverContext,
                                            const TargetConfiguration &config) {
...
void InferQuantizedTypesIntelPass::transformOperandType(CAGOperandAnchor *anchor,
                                                   Type newType) {
...
void InferQuantizedTypesIntelPass::transformResultType(CAGResultAnchor *anchor,
                                                  Type newType) {
...
ModulePassBase *mlir::quantizer::createInferQuantizedTypesIntelPass(
    SolverContext &solverContext, const TargetConfiguration &config) {
  return new InferQuantizedTypesIntelPass(solverContext, config);
}

static PassRegistration<InferQuantizedTypesIntelPass>
    pass("quantizer-infer-quantized-types-intel",
